...
import {
    ...
    SafeAreaView, Image, NativeModules, NativeEventEmitter, ActivityIndicator, Pressable
} from 'react-native';
...
class Momo extends Component {
    constructor(props) {
        ...
        this.state = {
            textAmount: this.formatNumberToMoney(this.props.total, null, ""),
            ...
            <View style={styles.container}>
                ...
                <View style={styles.formInput}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ flex: 1, fontSize: 18, paddingHorizontal: 10, color: 'black' }}>{"Total amount"}</Text>
                        <TextInput
                            autoFocus={true}
                            maxLength={10}
                            ...
                            style={[styles.textInput, { flex: 1, paddingRight: 30, color: 'black' }]}
